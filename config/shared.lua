        ...
        hospitals = {
            ...
            pillbox_lower = {
                ...
                beds = {
                    ...
                    { coords = vector4(341.93, -596.66, 42.94, 340.0), model = -119016924 },
                    { coords = vector4(314.82, -578.54, 28.46, 160.0), model = -119016924 },
                    { coords = vector4(334.96, -594.18, 42.94, 320.0), model = -119016924 },
                    { coords = vector4(319.06, -580.12, 28.46, 320.0), model = -119016924 },
                    { coords = vector4(323.36, -581.74, 28.46, 320.0), model = -119016924 },
                },
            },
            paleto = {
